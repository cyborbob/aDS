...
\begin{frame}Hidden Markov Model
	\begin{figure}
	\centering
		\includegraphics[scale=0.25]{./content/hiddenchain}
	\caption{Course AM207, Lecture 19: Pavlos Protopapas, Harvard University}
\end{figure}
\end{frame}

\begin{frame}Hidden Markov Model
	\begin{itemize}
		\item $T$ = length of observed sequence
		\item $N$ = number of states in the model
		\item $M$ = number of observable symbols
		...
		\item $\pi$ = \{$\pi_i$\}, $\pi_i$ = $Pr(q_i$ at $t = 0)$, \\
